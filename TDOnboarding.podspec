...
Pod::Spec.new do |s|
  s.name             = 'TDOnboarding'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TDOnboarding.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Anh Phan Tran/TDOnboarding'
  ...
  s.source_files = 'TDOnboarding/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TDOnboarding' => ['TDOnboarding/Assets/*.png']
  # }
