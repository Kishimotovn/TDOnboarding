...
class TDOnboardingViewController: UIViewController {
    ...
    @IBOutlet weak var bottomPannelHeightConstraint: NSLayoutConstraint!
    ...
    func setupUI() {
        ...
        self.bottomPannelHeightConstraint.constant = self.options.measure(for: .bottomPanelHeight) ?? 300.0
